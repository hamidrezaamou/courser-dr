...
<div class="tg-drawer" x-show="panel === 'prescription'" x-cloak @click.self="closePanel()">
    <div class="tg-drawer__panel max-w-xl" x-data="prescriptionForm(@js($drugsPayload), @js($prescriptionsPayload), @js(route('prescriptions.store', $patient)), @js($activeVisitId))"
        ...
        <form method="POST" :action="formAction" class="space-y-4" @submit="prepareSubmit">
            ...
            <div class="flex gap-2">
                ...
                <a
                    x-show="editingId"
                    x-cloak
                    :href="'{{ url('/patients/'.$patient->id.'/prescriptions') }}/' + editingId + '/print'"
                    target="_blank"
