            ...
            <section class="landing-hero">
                <header class="landing-top">
                    ...
                    <nav class="landing-top__nav">
                        @if (Route::has('login'))
                            @auth
                                <a href="{{ auth()->user()->role === 'patient' ? route('my-profile') : route('dashboard') }}" class="landing-top__link">ورود به پنل</a>
                            @else
                                <a href="{{ route('login') }}" class="landing-top__link landing-top__link--solid">ورود کارکنان</a>
                            @endauth
                        @endif
                    </nav>
                </header>
                ...
                <div class="landing-hero__stage">
                    <div class="landing-hero__copy landing-reveal">
                        ...
                        <div class="landing-hero__cta">
                            @if (Route::has('login'))
                                @auth
                                    <a href="{{ auth()->user()->role === 'patient' ? route('my-profile') : route('dashboard') }}" class="landing-btn landing-btn--primary">ادامه در پنل</a>
                                @else
                                    <a href="{{ route('login') }}" class="landing-btn landing-btn--primary">ورود به سامانه</a>
                                @endauth
                            @endif
                        </div>
                    </div>
            ...
            <section class="landing-close">
                <div class="landing-close__inner">
                    ...
                    <div class="landing-close__cta">
                        @if (Route::has('login'))
                            @auth
                                <a href="{{ auth()->user()->role === 'patient' ? route('my-profile') : route('dashboard') }}" class="landing-btn landing-btn--primary">ورود به پنل</a>
                            @else
                                <a href="{{ route('login') }}" class="landing-btn landing-btn--primary">ورود به سامانه</a>
                            @endauth
                        @endif
