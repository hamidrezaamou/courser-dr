<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between gap-3">
            <div>
                ...
                <p class="page-desc">بیمارستان را انتخاب کنید تا برگه‌های عمومی + مخصوص همان مرکز دیده شود. برای چاپ با مشخصات بیمار، شناسه نوبت را هم بزنید.</p>
            </div>
    ...
    <div class="py-4 sm:py-8">
        <div class="mx-auto max-w-xl space-y-5 px-4 sm:px-6">
            <form method="GET" action="{{ route('prints.index') }}" class="panel space-y-4 p-5">
                <div>
                ...
                <div class="flex flex-col gap-3 sm:flex-row sm:items-end">
                    <div class="flex-1">
                        <x-input-label value="شناسه نوبت عمل (اختیاری — برای چاپ با نام بیمار)" />
                ...
                <div class="panel space-y-4 p-5">
                    <div class="rounded-2xl border p-4" style="border-color: var(--line); background: var(--panel-soft);">
                        ...
                        <p class="mt-1 text-xs font-semibold" style="color: var(--muted);">
                            برای چاپ با مشخصات بیمار، شناسه نوبت را وارد کنید یا از گزارش‌ها → ابزار → پرینت وارد شوید.
                        </p>
                    </div>
