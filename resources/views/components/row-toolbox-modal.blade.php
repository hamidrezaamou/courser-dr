...
>
    ...
    {{-- Styles live here so the feature works without rebuilding public/build CSS. --}}
    <style>
        .rt-followup-form { display: grid; gap: 0.7rem; }
        .rt-followup-form__hint {
            margin: 0;
            font-size: 0.72rem;
            font-weight: 700;
            color: var(--muted);
        ...
        @media (max-width: 420px) {
            .rt-followup-row { grid-template-columns: 1fr; }
        }
        .rt-followup-presets {
            display: flex;
            flex-wrap: wrap;
        ...
        .rt-followup-presets button:hover {
            border-color: color-mix(in srgb, var(--brand) 35%, var(--line));
            background: color-mix(in srgb, var(--brand-soft) 70%, var(--panel));
        }
        .rt-followup-presets button.is-active {
    ...
    <div class="rt-status-overlay" data-bulk-followup-overlay style="display:none" aria-hidden="true">
        <div class="rt-status-sheet rt-followup-sheet" role="dialog" aria-modal="true" aria-label="پیگیری گروهی">
            ...
            <form class="rt-followup-form" data-bulk-followup-form>
                ...
                <div class="rt-status-sheet__confirm-acts" style="display:flex;gap:0.4rem;margin-top:0.7rem;justify-content:flex-end;flex-wrap:wrap">
        ...
        if (bulkFollowupOverlay) {
            ...
            if (presets) {
                presets.addEventListener('click', function (e) {
                    ...
                    presets.querySelectorAll('[data-preset]').forEach(function (el) {
