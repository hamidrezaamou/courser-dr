...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex items-center justify-between gap-3">
            ...
            <a href="<?php echo e(route('patients.show', $patient)); ?>" class="btn-ghost !text-xs !px-2.5 !py-1.5">پرونده</a>
        </div>
     <?php $__env->endSlot(); ?>

    <div class="py-4 sm:py-8" x-data="{ noNationalCode: <?php echo \Illuminate\Support\Js::from((bool) old('no_national_code', blank($patient->national_code)))->toHtml() ?> }">
        <div class="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
            <form method="POST" action="<?php echo e(route('appointments.store', $patient)); ?>" class="panel fade-up space-y-6 p-5 sm:p-8">
                <?php echo csrf_field(); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'national_code','name' => 'national_code','type' => 'text','inputmode' => 'numeric','maxlength' => '10','class' => 'mt-1 block w-full font-mono','dir' => 'ltr','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('national_code', $patient->national_code)),'x-bind:required' => '!noNationalCode','x-bind:disabled' => 'noNationalCode','x-on:input' => '$el.value = $el.value.replace(/[۰-۹]/g, d => \'۰۱۲۳۴۵۶۷۸۹\'.indexOf(d)).replace(/[٠-٩]/g, d => \'٠١٢٣٤٥٦٧٨٩\'.indexOf(d)).replace(/\D/g, \'\').slice(0, 10)']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal18c21970322f9e5c938bc954620c12bb)): ?>
<?php $attributes = $__attributesOriginal18c21970322f9e5c938bc954620c12bb; ?>
...
<?php endif; ?>
                        <?php if (isset($component)) { $__componentOriginal18c21970322f9e5c938bc954620c12bb = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal18c21970322f9e5c938bc954620c12bb = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.text-input','data' => ['id' => 'mobile','name' => 'mobile','type' => 'text','inputmode' => 'tel','maxlength' => '11','class' => 'mt-1 block w-full font-mono','dir' => 'ltr','value' => old('mobile', $patient->mobile),'required' => true,'xOn:input' => '$el.value = $el.value.replace(/[۰-۹]/g, d => \'۰۱۲۳۴۵۶۷۸۹\'.indexOf(d)).replace(/[٠-٩]/g, d => \'٠١٢٣٤٥٦٧٨٩\'.indexOf(d)).replace(/\D/g, \'\').slice(0, 11)']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('text-input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'mobile','name' => 'mobile','type' => 'text','inputmode' => 'tel','maxlength' => '11','class' => 'mt-1 block w-full font-mono','dir' => 'ltr','value' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(old('mobile', $patient->mobile)),'required' => true,'x-on:input' => '$el.value = $el.value.replace(/[۰-۹]/g, d => \'۰۱۲۳۴۵۶۷۸۹\'.indexOf(d)).replace(/[٠-٩]/g, d => \'٠١٢٣٤٥٦٧٨٩\'.indexOf(d)).replace(/\D/g, \'\').slice(0, 11)']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal18c21970322f9e5c938bc954620c12bb)): ?>
<?php $attributes = $__attributesOriginal18c21970322f9e5c938bc954620c12bb; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.booking-datetime','data' => ['kind' => 'visit','mode' => 'select']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['kind' => 'visit','mode' => 'select']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\elahe\Downloads\Compressed\app_3\resources\views\appointments\create.blade.php ENDPATH**/ ?>