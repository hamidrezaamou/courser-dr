...
<?php $component->withAttributes([]); ?>
    ...
    >
        <div class="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
            <form
                method="POST"
                action="<?php echo e(route('surgery-appointments.register.store')); ?>"
            ...
            >
                ...
                <div class="flex flex-wrap gap-3">
                    <button type="submit" class="btn-primary btn-accent-warm">ثبت عمل و پرونده</button>
...
<?php endif; ?>
<?php /**PATH C:\Users\elahe\Downloads\Compressed\app_3\resources\views\surgery-appointments\register.blade.php ENDPATH**/ ?>