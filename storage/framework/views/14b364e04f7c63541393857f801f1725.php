    ...
    >
        <div class="booking-calendar-content" @click.stop>
            ...
            <div class="cal-legend px-1">
                ...
                <span><i class="lg-full"></i> تکمیل‌شده</span>
                <span><i class="lg-off"></i> بدون برنامه / غیرفعال</span>
            </div>
        </div>
    </div>
</template>
<?php /**PATH C:\Users\elahe\Downloads\Compressed\app_3\resources\views\surgery-appointments\partials\calendar-modal.blade.php ENDPATH**/ ?>