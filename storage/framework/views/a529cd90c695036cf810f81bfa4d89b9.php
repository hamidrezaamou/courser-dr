...
<?php endif; ?>
            ...
            <div class="grid gap-3 sm:grid-cols-3">
                <div class="panel p-4 text-center">
                    <div class="text-2xl font-bold" style="color: var(--brand-dark);"><?php echo e($portalPatients); ?></div>
                    <div class="mt-1 text-xs" style="color: var(--muted);">بیمار با حساب کاربری</div>
                </div>
                <div class="panel p-4 text-center">
                    <div class="text-2xl font-bold" style="color: var(--ink);"><?php echo e($totalPatients); ?></div>
                    <div class="mt-1 text-xs" style="color: var(--muted);">کل پرونده‌ها</div>
                </div>
                <div class="panel p-4 text-center">
                    <div class="text-2xl font-bold" style="color: var(--warn);"><?php echo e(max(0, $totalPatients - $portalPatients)); ?></div>
            ...
            <div class="panel space-y-3 p-4 text-sm leading-7">
                ...
                <?php if(auth()->user()?->canManageSettings()): ?>
                    <a href="<?php echo e(route('admin.users.create')); ?>" class="btn-primary inline-flex !py-2">ساخت کاربر بیمار</a>
                <?php endif; ?>
            </div>
        </div>
    </div>
...
<?php endif; ?>
<?php /**PATH C:\Users\elahe\Downloads\Compressed\app_3\resources\views\modules\portal\index.blade.php ENDPATH**/ ?>