...
<article class="<?php echo \Illuminate\Support\Arr::toCssClasses([
    ...
    <div class="admin-feature-card__main">
        ...
        <div class="admin-feature-card__body min-w-0">
            <div class="admin-feature-card__head">
                <h4 class="admin-feature-card__title"><?php echo e($meta['label']); ?></h4>
                <?php if($planned): ?>
                    <span class="admin-feature-card__badge">ماژول پیشرفته</span>
                <?php endif; ?>
                <span class="admin-feature-card__status"><?php echo e($enabled ? 'فعال' : 'غیرفعال'); ?></span>
            </div>
            <p class="admin-feature-card__hint"><?php echo e($meta['hint']); ?></p>
            ...
            <?php if($featured && ! $enabled && $offNote): ?>
                <p class="admin-feature-card__note"><?php echo e($offNote); ?></p>
            <?php endif; ?>

            <?php if($planned && $enabled && $onNote): ?>
                <p class="admin-feature-card__note admin-feature-card__note--info"><?php echo e($onNote); ?></p>
            <?php elseif($planned && $enabled): ?>
    ...
    <label class="admin-feature-switch" title="<?php echo e($enabled ? 'غیرفعال کردن' : 'فعال کردن'); ?>">
        <input type="checkbox" name="<?php echo e($field); ?>" value="1" <?php if(old($field, $enabled)): echo 'checked'; endif; ?>>
        <span class="admin-feature-switch__track" aria-hidden="true">
            <span class="admin-feature-switch__thumb"></span>
        </span>
        <span class="sr-only"><?php echo e($meta['label']); ?></span>
    </label>
</article>
<?php /**PATH C:\Users\elahe\Downloads\Compressed\app_3\resources\views\components\admin-feature-card.blade.php ENDPATH**/ ?>