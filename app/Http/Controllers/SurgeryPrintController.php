...
class SurgeryPrintController extends Controller
{
        ...
        foreach ($this->typeCatalog($surgeryAppointment) as $type) {
            ...
            if ($meta['mode'] === 'overlay') {
                $sheets[] = [
                    ...
                    'show_signature' => (bool) ($meta['sheet']['show_signature'] ?? true),
                    'show_header_spacer' => (bool) ($meta['sheet']['show_header_spacer'] ?? true),
                ];
    ...
    public function show(SurgeryAppointment $surgeryAppointment, string $type): View
    {
        ...
        if ($meta['mode'] === 'overlay') {
            ...
            $shared['showSignature'] = (bool) ($meta['sheet']['show_signature'] ?? true);
            $shared['showHeaderSpacer'] = (bool) ($meta['sheet']['show_header_spacer'] ?? true);
